            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-2 mb-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Super Admins</h1>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Manage super administrator accounts with full system access</p>
                </div>
                ...
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
                    ...
                    <button 
                        ...
                        class="bg-blue-600 dark:bg-blue-700 hover:bg-blue-700 dark:hover:bg-blue-600 text-white px-6 py-3 rounded-full flex items-center justify-center space-x-2 transition-all duration-200 w-full lg:w-auto text-sm lg:text-base shadow-md hover:shadow-lg active:scale-95"
                    >
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Super Admins</h3>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ superAdmins.length }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Active Today</h3>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ stats?.activeToday || 0 }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Last 7 Days</h3>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">{{ stats?.last7Days || 0 }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">System Access</h3>
                                <p class="text-2xl font-bold text-gray-900 dark:text-white mt-1">Full</p>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
                    <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
                            <h3 class="text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200">Super Administrators</h3>
                            <div class="relative w-full lg:w-auto">
                                <input 
                                    type="text" 
                                    v-model="searchQuery"
                                    placeholder="Search super admins..." 
                                    class="w-full lg:w-64 pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-sm lg:text-base placeholder-gray-500 dark:placeholder-gray-400"
                                >
                    ...
                    <div class="lg:hidden divide-y divide-gray-200 dark:divide-gray-700">
                        <div v-for="user in filteredSuperAdmins" :key="user.id" class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            <div class="flex items-start space-x-3 mb-3">
                                <div class="relative">
                                    <div v-if="user.profile_picture_url" class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 border-2 border-blue-600 dark:border-blue-500">
                                        <img 
                                    ...
                                    <div v-else class="w-10 h-10 bg-blue-600 dark:bg-blue-700 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="hidden lg:block overflow-x-auto">
                        <table class="w-full">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                <tr v-for="user in filteredSuperAdmins" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-center">
                                            <div class="relative">
                                                <div v-if="user.profile_picture_url" class="w-16 h-16 rounded-full overflow-hidden border-2 border-blue-600 dark:border-blue-500">
                                                    <img 
                                                        :src="user.profile_picture_url" 
                                                        :alt="user.name"
                                                        class="w-full h-full object-cover"
                                                ...
                                                <div v-else class="w-16 h-16 bg-blue-600 dark:bg-blue-700 rounded-full flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-gray-100 max-w-xs truncate">{{ user.address || 'N/A' }}</div>
                    ...
                    <div v-if="filteredSuperAdmins.length === 0" class="text-center py-8 lg:py-12">
                        ...
                        <h3 class="text-base lg:text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No super admins found</h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm lg:text-base mb-4">Get started by creating your first super administrator.</p>
                        <button 
                            @click="showCreateModal = true"
                ...
                <div v-if="showCreateModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Create New Super Admin</h3>
                        </div>
                        ...
                        <form @submit.prevent="createSuperAdmin" class="p-4 lg:p-6 space-y-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        type="text" 
                                        required
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent text-sm lg:text-base"
                            ...
                            <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-blue-700 dark:text-blue-300">This user will be created as a <strong>Super Admin</strong> with full system access.</span>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button 
                                    ...
                                    class="px-6 py-3 bg-blue-600 dark:bg-blue-700 text-white rounded-full hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed text-sm lg:text-base order-1 sm:order-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                                >
                ...
                <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Edit Super Admin</h3>
                        </div>
                        ...
                        <form @submit.prevent="updateSuperAdmin" class="p-4 lg:p-6 space-y-4">
                            ...
                            <div v-if="editingUser && editingUser.profile_picture_url" class="flex items-center">
                                <input 
                                    ...
                                    class="h-4 w-4 text-blue-600 dark:text-blue-500 focus:ring-blue-500 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700"
                                >
                            ...
                            <div class="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-blue-700 dark:text-blue-300">This user is a <strong>Super Admin</strong> with full system access.</span>
                                </div>
                            </div>
                        ...
                        <div class="p-4 lg:p-6">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mb-6">
                                <div class="flex space-x-2">
                                    ...
                                    <button @click="autoCrop" class="bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 dark:hover:bg-purple-600 text-white px-4 py-2 rounded-lg text-sm flex items-center">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="flex justify-end space-x-2">
                                <button 
                                    @click="cancelCropperWithCleanup" 
                                ...
                                <button 
                                    @click="applyCrop" 
                                    class="px-6 py-3 bg-blue-600 dark:bg-blue-700 text-white rounded-full hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors text-sm lg:text-base"
...
const handleFileSelect = (event) => {
    ...
    reader.onload = (e) => {
        ...
        // Automatically open cropper modal
        ...
        nextTick(() => {
            resetCrop()
            setSquareCrop() // Set default square crop
...
const autoCrop = () => {
    ...
    // Set default square crop in the center
    setSquareCrop()
    
    // Auto-apply the crop after a short delay
    setTimeout(() => {
        applyCrop()
    }, 100)
}
...
const cancelCropperWithCleanup = () => {
    showCropper.value = false
    resetCrop()
    removeEventListeners()
