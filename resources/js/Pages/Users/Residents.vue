            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-2 mb-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Residents</h1>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Manage hostel resident accounts and information</p>
                </div>
                ...
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <button 
                            ...
                            class="bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white px-6 py-3 rounded-full flex items-center justify-center space-x-2 transition-all duration-200 text-sm lg:text-base shadow-md hover:shadow-lg active:scale-95"
                        >
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Residents</h3>
                                <p class="text-2xl font-bold text-red-600 dark:text-red-400 mt-1">{{ users.length }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ stats?.occupancyRate || '0%' }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">New This Month</h3>
                                <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ stats?.newThisMonth || 0 }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md dark:hover:shadow-lg transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Pending Fees</h3>
                                <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ formatCurrency(stats?.pendingFees || 0) }}</p>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
                    <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
                            <h3 class="text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200">Residents</h3>
                            <div class="text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div class="lg:hidden divide-y divide-gray-200 dark:divide-gray-700">
                        <div v-for="user in filteredUsers" :key="user.id" class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            <div class="flex items-start space-x-3 mb-3">
                                <div class="relative">
                                    <div v-if="user.profile_picture_url" class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 border-2 border-red-600 dark:border-red-500">
                                        <img 
                                    ...
                                    <div v-else class="w-10 h-10 bg-red-600 dark:bg-red-700 rounded-full flex items-center justify-center flex-shrink-0">
                        ...
                        <table class="w-full">
                            <thead class="bg-gray-50 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Resident</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Contact & Room</th>
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Guardian</th>
                                ...
                                <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-center">
                                            <div class="relative">
                                                <div v-if="user.profile_picture_url" class="w-16 h-16 rounded-full overflow-hidden border-2 border-red-600 dark:border-red-500">
                                                    <img 
                                                        :src="user.profile_picture_url" 
                                                        :alt="user.name"
                                                        class="w-full h-full object-cover"
                                                ...
                                                <div v-else class="w-16 h-16 bg-red-600 dark:bg-red-700 rounded-full flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500 dark:text-gray-400">Admitted: {{ formatDate(user.admission_date) }}</div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">{{ user.phone || 'N/A' }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ user.hostel?.name || 'Unassigned' }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">Room: {{ user.room_number || 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">{{ user.guardian_name || 'N/A' }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ user.guardian_phone || 'N/A' }}</div>
                                        <div class="text-sm text-gray-500 dark:text-gray-400">{{ user.emergency_contact || 'N/A' }}</div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <div v-if="filteredUsers.length === 0" class="text-center py-8 lg:py-12">
                        ...
                        <h3 class="text-base lg:text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No residents found</h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm lg:text-base mb-4">Get started by admitting new residents.</p>
                        <div class="flex flex-col sm:flex-row gap-3 justify-center">
                            ...
                            <button 
                                @click="showCreateModal = true"
                                class="bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white px-6 py-3 rounded-full transition-colors text-sm lg:text-base shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                            >
                                Add Resident
                            </button>
                        </div>
                ...
                <div v-if="showCreateModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Create New Resident</h3>
                        </div>
                        ...
                        <form @submit.prevent="createUser" class="p-4 lg:p-6 space-y-6">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex flex-col items-center space-y-4">
                                    <!-- Preview -->
                                    <div class="relative">
                                        <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-red-100 dark:border-red-900/30">
                                            <img 
                                                ref="profilePreview"
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button 
                                            ...
                                            class="bg-red-600 dark:bg-red-700 hover:bg-red-700 dark:hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm flex items-center"
                                        >
                            ...
                            <div class="space-y-4">
                                <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 border-b pb-2 border-gray-200 dark:border-gray-700">Personal Information</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            type="text" 
                                            required
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            type="date" 
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.dob }"
                                        >
                                        <div v-if="form.errors.dob" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.dob }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.emergency_contact }"
                                        >
                                        <div v-if="form.errors.emergency_contact" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.emergency_contact }}</div>
                                    </div>
                                    <div>
                            ...
                            <div class="space-y-4">
                                <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 border-b pb-2 border-gray-200 dark:border-gray-700">Guardian Information</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.guardian_name }"
                                        >
                                        <div v-if="form.errors.guardian_name" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.guardian_name }}</div>
                                    </div>
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.guardian_phone }"
                                        >
                                        <div v-if="form.errors.guardian_phone" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.guardian_phone }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Hostel Assignment -->
                            <div class="space-y-4">
                                <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 border-b pb-2 border-gray-200 dark:border-gray-700">Hostel Assignment</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Hostel *</label>
                                        <select 
                                            v-model="form.hostel_id"
                                            required
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.hostel_id }"
                                        >
                                        ...
                                        <div v-if="form.errors.hostel_id" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.hostel_id }}</div>
                                    </div>
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.room_id }"
                                        >
                                        ...
                                        <div v-if="form.errors.room_id" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.room_id }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            type="date" 
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.admission_date }"
                                        >
                                        <div v-if="form.errors.admission_date" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.admission_date }}</div>
                                    </div>
                                    <div>
                                        ...
                                        <select 
                                            v-model="form.status"
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': form.errors.status }"
                                        >
                                            <option value="active">Active</option>
                                            <option value="inactive">Inactive</option>
                                            <option value="graduated">Graduated</option>
                                        ...
                                        <div v-if="form.errors.status" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ form.errors.status }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Password -->
                            <div class="space-y-4">
                                <h4 class="text-lg font-medium text-gray-900 dark:text-gray-100 border-b pb-2 border-gray-200 dark:border-gray-700">Account Credentials</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                            ...
                            <div class="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-red-700 dark:text-red-300">This user will be created as a <strong>Resident</strong> with access to hostel facilities and personal dashboard.</span>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button 
                                    ...
                                    class="px-6 py-3 bg-red-600 dark:bg-red-700 text-white rounded-full hover:bg-red-700 dark:hover:bg-red-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed text-sm lg:text-base order-1 sm:order-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                                >
                ...
                <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Edit Resident</h3>
                        </div>
                        ...
                        <form @submit.prevent="updateUser" class="p-4 lg:p-6 space-y-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            type="date" 
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.dob }"
                                        >
                                        <div v-if="editForm.errors.dob" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.dob }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            placeholder="Enter emergency contact"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.emergency_contact }"
                                        >
                                        <div v-if="editForm.errors.emergency_contact" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.emergency_contact }}</div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Address</label>
                                        <textarea 
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            placeholder="Enter guardian name"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.guardian_name }"
                                        >
                                        <div v-if="editForm.errors.guardian_name" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.guardian_name }}</div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Guardian Phone</label>
                                        <input 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            placeholder="Enter guardian phone"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.guardian_phone }"
                                        >
                                        <div v-if="editForm.errors.guardian_phone" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.guardian_phone }}</div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select 
                                            ...
                                            required
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.hostel_id }"
                                        >
                                            <option value="">Select Hostel</option>
                                            <option v-for="hostel in hostels" :key="hostel.id" :value="hostel.id">
                                                {{ hostel.name }}
                                        ...
                                        <div v-if="editForm.errors.hostel_id" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.hostel_id }}</div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Room</label>
                                        <select 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.room_id }"
                                        >
                                            <option value="">Select Room</option>
                                            <option v-for="room in rooms" :key="room.id" :value="room.id">
                                                {{ room.room_number }} - {{ room.branch?.name }}
                                        ...
                                        <div v-if="editForm.errors.room_id" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.room_id }}</div>
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input 
                                            ...
                                            type="date" 
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.admission_date }"
                                        >
                                        <div v-if="editForm.errors.admission_date" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.admission_date }}</div>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Status</label>
                                        <select 
                                            ...
                                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 dark:focus:ring-red-400 focus:border-transparent text-sm lg:text-base"
                                            :class="{ 'border-red-300 dark:border-red-500': editForm.errors.status }"
                                        >
                                            <option value="active">Active</option>
                                            <option value="inactive">Inactive</option>
                                            <option value="graduated">Graduated</option>
                                        ...
                                        <div v-if="editForm.errors.status" class="text-red-500 dark:text-red-400 text-sm mt-1">{{ editForm.errors.status }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div v-if="editingUser && editingUser.profile_picture_url" class="flex items-center">
                                <input 
                                    ...
                                    class="h-4 w-4 text-red-600 dark:text-red-500 focus:ring-red-500 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700"
                                >
                            ...
                            <div class="p-4 bg-red-50 dark:bg-red-900/20 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-red-700 dark:text-red-300">This user is a <strong>Resident</strong> with access to hostel facilities and personal dashboard.</span>
                                </div>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="p-4 lg:p-6">
                            ...
                            <div class="flex justify-end space-x-2">
                                ...
                                <button 
                                    @click="applyCrop" 
                                    class="px-6 py-3 bg-red-600 dark:bg-red-700 text-white rounded-full hover:bg-red-700 dark:hover:bg-red-600 transition-colors text-sm lg:text-base"
...
const getStatusClasses = (status) => {
    switch(status) {
        ...
        case 'graduated': return 'bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300'
...
.dark h4.text-lg.font-medium {
    color: #f3f4f6;
}

/* Status badge animation */
.px-2.inline-flex.text-xs {
    transition: all 0.2s ease;
}

.px-2.inline-flex.text-xs:hover {
...
.p-2.bg-red-100:hover svg {
    transform: scale(1.1);
}

.dark .p-2.bg-red-900\/30:hover svg {
    transform: scale(1.1);
}
...
/* Button group for empty state */
.flex.flex-col.sm\\:flex-row.gap-3 {
    gap: 0.75rem;
}

/* Hostel/room select styling */
select option {
    padding: 8px;
}
...
/* Profile picture border for residents */
.border-2.border-red-600 {
    border-color: #dc2626;
}

.dark .border-2.border-red-500 {
    border-color: #ef4444;
}
</style>