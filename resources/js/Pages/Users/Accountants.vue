<template>
    <Head title="Accountants Management" />
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    <div class="flex items-center space-x-2 mb-2">
                        ...
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Accountants</h1>
                    </div>
                    <p class="text-gray-600 dark:text-gray-300 mt-2">Manage accountant accounts for financial operations</p>
                </div>
                ...
                <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4 mb-6">
                    ...
                    <button 
                        ...
                        class="bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 dark:hover:bg-purple-600 text-white px-6 py-3 rounded-full flex items-center justify-center space-x-2 transition-all duration-200 w-full lg:w-auto text-sm lg:text-base shadow-md hover:shadow-lg active:scale-95"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                        <span class="font-medium">Add Accountant</span>
                    </button>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Total Accountants</h3>
                                <p class="text-2xl font-bold text-purple-600 dark:text-purple-400 mt-1">{{ users.length }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Processed Payments</h3>
                                <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ stats?.processedPayments || '0' }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-blue-600 dark:text-blue-400 mt-1">{{ formatCurrency(stats?.totalRevenue || 0) }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md transition-shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold text-red-600 dark:text-red-400 mt-1">{{ stats?.pendingInvoices || 0 }}</p>
                            </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden mb-8">
                    <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <div class="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-4">
                            <h3 class="text-base lg:text-lg font-semibold text-gray-800 dark:text-gray-200">Accountants</h3>
                            <div class="relative w-full lg:w-auto">
                                <input 
                                    type="text" 
                                    v-model="searchQuery"
                                    placeholder="Search accountants..." 
                                    class="w-full lg:w-64 pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-sm lg:text-base placeholder-gray-500 dark:placeholder-gray-400"
                                >
                    ...
                    <div class="lg:hidden divide-y divide-gray-200 dark:divide-gray-700">
                        <div v-for="user in filteredUsers" :key="user.id" class="p-4 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                            <div class="flex items-start space-x-3 mb-3">
                                <div class="relative">
                                    <div v-if="user.profile_picture_url" class="w-10 h-10 rounded-full overflow-hidden flex items-center justify-center flex-shrink-0 border-2 border-purple-600 dark:border-purple-500">
                                        <img 
                                    ...
                                    <div v-else class="w-10 h-10 bg-purple-600 dark:bg-purple-700 rounded-full flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="space-y-2 text-sm text-gray-600 dark:text-gray-300 mb-3">
                                ...
                                <div><strong>Role:</strong> Accountant</div>
                            </div>
                                ...
                                <tr v-for="user in filteredUsers" :key="user.id" class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex justify-center">
                                            <div class="relative">
                                                <div v-if="user.profile_picture_url" class="w-16 h-16 rounded-full overflow-hidden border-2 border-purple-600 dark:border-purple-500">
                                                    <img 
                                                        :src="user.profile_picture_url" 
                                                        :alt="user.name"
                                                        class="w-full h-full object-cover"
                                                ...
                                                <div v-else class="w-16 h-16 bg-purple-600 dark:bg-purple-700 rounded-full flex items-center justify-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900 dark:text-gray-100">Accountant</div>
                    ...
                    <div v-if="filteredUsers.length === 0" class="text-center py-8 lg:py-12">
                        ...
                        <h3 class="text-base lg:text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">No accountants found</h3>
                        <p class="text-gray-500 dark:text-gray-400 text-sm lg:text-base mb-4">Get started by creating your first accountant.</p>
                        <button 
                            @click="showCreateModal = true"
                            class="bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 dark:hover:bg-purple-600 text-white px-6 py-3 rounded-full transition-colors text-sm lg:text-base shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                        >
                            Add Accountant
                        </button>
                    </div>
                ...
                <div v-if="showCreateModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Create New Accountant</h3>
                        </div>
                        ...
                        <form @submit.prevent="createUser" class="p-4 lg:p-6 space-y-4">
                            ...
                            <div class="mb-6">
                                ...
                                <div class="flex flex-col items-center space-y-4">
                                    <!-- Preview -->
                                    <div class="relative">
                                        <div class="w-32 h-32 rounded-full overflow-hidden border-4 border-purple-100 dark:border-purple-900/30">
                                            <img 
                                                ref="profilePreview"
                                    ...
                                    <div class="flex space-x-2">
                                        ...
                                        <button 
                                            ...
                                            class="bg-purple-600 dark:bg-purple-700 hover:bg-purple-700 dark:hover:bg-purple-600 text-white px-4 py-2 rounded-lg text-sm flex items-center"
                                        >
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        type="text" 
                                        required
                                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-500 dark:focus:ring-purple-400 focus:border-transparent text-sm lg:text-base"
                            ...
                            <div class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-purple-500 dark:text-purple-400 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                    <span class="text-sm text-purple-700 dark:text-purple-300">This user will be created as an <strong>Accountant</strong> with financial management access.</span>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button 
                                    ...
                                    class="px-6 py-3 bg-purple-600 dark:bg-purple-700 text-white rounded-full hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed text-sm lg:text-base order-1 sm:order-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                                >
                                    {{ form.processing ? 'Creating...' : 'Create Accountant' }}
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <div v-if="showEditModal" class="fixed inset-0 bg-black bg-opacity-50 dark:bg-opacity-70 flex items-center justify-center p-4 z-50">
                    <div class="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto mx-2">
                        <div class="px-4 lg:px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                            <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200">Edit Accountant</h3>
                        </div>
                        ...
                        <form @submit.prevent="updateUser" class="p-4 lg:p-6 space-y-4">
                            ...
                            <div v-if="editingUser && editingUser.profile_picture_url" class="flex items-center">
                                <input 
                                    ...
                                    class="h-4 w-4 text-purple-600 dark:text-purple-500 focus:ring-purple-500 border-gray-300 dark:border-gray-600 rounded bg-white dark:bg-gray-700"
                                >
                            ...
                            <div class="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
                                <div class="flex items-center">
                                    ...
                                    <span class="text-sm text-purple-700 dark:text-purple-300">This user is an <strong>Accountant</strong> with financial management access.</span>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                                ...
                                <button 
                                    ...
                                    class="px-6 py-3 bg-purple-600 dark:bg-purple-700 text-white rounded-full hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors disabled:bg-gray-400 disabled:cursor-not-allowed text-sm lg:text-base order-1 sm:order-2 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200"
                                >
                                    {{ editForm.processing ? 'Updating...' : 'Update Accountant' }}
                                </button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg w-full max-w-4xl max-h-[90vh] overflow-y-auto">
                        ...
                        <div class="p-4 lg:p-6">
                            ...
                            <div class="flex justify-end space-x-2">
                                ...
                                <button 
                                    @click="applyCrop" 
                                    class="px-6 py-3 bg-purple-600 dark:bg-purple-700 text-white rounded-full hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors text-sm lg:text-base"
...
const form = useForm({
    ...
    role_id: null, // This should be set to Accountant role ID
...
// Methods
const createUser = () => {
    // Set role_id to Accountant role (you need to get this from props or API)
    form.role_id = 3; // Assuming Accountant role has ID 3
...
.dark .border-4.border-purple-100 {
